...
1. Place the `FreeRangeCameraLite` folder in the archive in your BepInEx `Plugins` folder.
...
## Meta
### Source code
[Available on GitHub](https://github.com/algernon-A/FreeRangeCameraLite) (algernon-A/FreeRangeCameraLite).
